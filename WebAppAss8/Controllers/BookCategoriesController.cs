...
namespace WebAppAss8.Controllers
{
    public class BookCategoriesController : Controller
    {
        ...
        public BookCategoriesController(BookDb18Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.BookCategories != null ? 
                          ...
                          Problem("Entity set 'BookDb18Context.BookCategories'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BookDb18Context.BookCategories'  is null.");
            }
            var bookCategory = await _context.BookCategories.FindAsync(id);
            if (bookCategory != null)
            {
